...
extension ColorTableViewController: UITableViewDelegate,
     ...
     func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
         self.didSelectColor(colorViewModel.getColorByIndex(indexPath.row))
     }
     ...
     func tableView(_ tableView: UITableView, moveRowAt sourceIndexPath: IndexPath, to destinationIndexPath: IndexPath) {
         ...
         let fromPosition = sourceIndexPath.row
         let toPosition = destinationIndexPath.row
         colorViewModel.moveRow(from: fromPosition, To: toPosition)
